...
const Support = () => {
	return (
		<div className='container mt-5 support_others_projects'>
				...
				<div className="row">
					...
					<div className="col-lg-9 col-md-12 p-0 mt-4 support_others_projects__author-right">
						<div className="d-flex">
							...
							<img src="../image/page5_support_star.svg" className="px-1" />
							<img src="../image/page5_support_star.svg" />
						</div>
						<div class="d-flex mt-2">
							<div className="text-success support_others_projects__author__campaign">12 Campaign</div>
							<img src="../image/page5_support_dot.svg" className="mx-3" />
							<div className="support_others_projects__author__location">New York, London</div>
						</div>
					</div>
				</div>
			</div>
			<div className='d-flex justify-content-center'>
				<button className='text-white mt-4 support_others_projects__button'>Fund This Project</button>
			</div>
			...
			<div className='d-flex justify-content-center'>
				<button className='text-white mt-4 support_others_projects__button mb-5'>Fund This Project</button>
			</div>
		</div>
	)
}
