    ...
    return (
        <div className="col-lg-4 col-md-12 mt-5">
            <div className="we_have_done__item px-4">
                <img src="./images/page5_project_background.svg" className="mt-4 img-fluid" />
                ...
                <div className="row mt-4 we_have_done__item__author">
                    <div className="col-lg-2 col-md-12">
                        <img src="./images/page5_project_author.svg" />
                    </div>
                    <div className="col-lg-10 col-md-12">
                        <div className="mx-2">
                            <div className="d-flex">
                                <div className="we_have_done__item__author__author">{project.author}</div>
                                <img src="./images/page5_project_star.svg" style={{ marginLeft: '10px' }} />
                                <img src="./images/page5_project_star.svg" className="px-1" />
                                <img src="./images/page5_project_star.svg" />
                            </div>
                            <div className="d-flex mt-2">
                                <div className="text-success we_have_done__item__author__campaign">{project.campaign}</div>
                                <img src="./page5_project_images/dot.svg" className="mx-2" />
