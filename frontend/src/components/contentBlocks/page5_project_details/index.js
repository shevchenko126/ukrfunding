    ...
    <div className="container mt-5 project_details__main">
        <div className="row">
            <div className="col-lg-6 project_details__main__left">
                <div className="mt-3">
                    <iframe className="project_details__main__left__main_video" src="https://www.youtube.com/embed/nybtOIxlku8" title="YouTube video player"></iframe>
                </div>
                <div className="row text-center mt-4">
                    <div className="col">
                        <iframe width="176" height="150" src="https://www.youtube.com/embed/nybtOIxlku8" title="YouTube video player"></iframe>
                    </div>
                    <div className="col">
                        <iframe width="176" height="150" src="https://www.youtube.com/embed/nybtOIxlku8" title="YouTube video player"></iframe>
                    </div>
            ...
            <div className="col-lg-6 mt-3 project_details__main__right">
                <div className="row">
                    <div className="col-lg-9 col-sm-12 text-center">
                        <div className="d-flex">
                            <img src="/images/page_5_icon.svg" />
                            <div style="margin-left: 20px;">
                                <div className="d-flex">
                                    <div className="h5">Hendric Anderson</div>
                                    <div style="margin-left: 15px;">
                                        <img src="/images/page_5_star.svg" />
                                        <img src="/images/page_5_star.svg" />
                                        <img src="/images/page_5_star.svg" />
                                    </div>
                                </div>
                                <div className="d-flex mt-2">
                                    ...
                                    <img src="/images/page_5_dot.svg" style="margin: -3px 10px 0 10px;" />
                                    <div style="margin-top: -1px">New York, London</div>
                                </div>
                            </div>
                        </div>
                    </div>                   
                    <div className="col-lg-3 col-sm-12 mt-3">
                        <img src="/images/page_5_heart.svg" />
                        <img src="/images/page_5_share.svg" style="margin: 0 30px;" />
                        <img src="/images/page_5_flag.svg" />
                        </div>
                </div>
                ...
                <div>
                    <progress max="100" value="65" className="mt-5 project_details__main__right__main__bar"></progress>
                </div>
                <div className="row mt-4">
                    <div className="col-lg-4 mt-3 col-md-12">
                        <div className="d-flex">
                            <img src="/images/page_5_coins.svg" style="margin-top: -18px"/>
                    ...
                    <div className="col-lg-4 mt-3 col-md-12">
                        <div className="d-flex">
                            <img src="/images/page_5_calendar.svg" style="margin-top: -18px" />
                            <div style="margin-left: 25px;">
