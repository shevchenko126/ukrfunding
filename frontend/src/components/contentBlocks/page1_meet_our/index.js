...
const TeamMember = () => {
	return (
		<div>
			<div className="container p-0 team_members__header">
			...
			<div className="container p-0 team_members__main">
				<div className="row">
					<div className="col">
						<img src="'/images/page_1_team_member_profile.svg" className="team_members__main__profile"/>
					...
					<div className="col">
						<img src="/images/page_1_team_member_/profile.svg" className="team_members__main__profile" />
