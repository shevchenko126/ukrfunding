			...
			<div className="row">
				<div className="col-lg-8 col-md-12">
					...
					<div className="item" style={{ maxWidth: '802px' }}>
						<div className="d-flex">
							...
							<div className="mt-4 who_we_are__item__right">
								...
								<p className="mt-2 pb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
							</div>
						</div>
					</div>
					<div className="mt-5 mb-5 item" style={{ maxWidth: '802px' }}>
						<div className="d-flex">
							<div>
								<img alt="#" src="../image/page2_who_we_are_trust.svg" className="mt-4" />
							</div>
							<div className="mt-4">
