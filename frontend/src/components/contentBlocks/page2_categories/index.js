...
const Page2Categories = () => {
	return (
		...
		<div className="container p-0 categories-main">
			<div className="row d-flex justify-content-between">
				<div className="col-lg-6 col-md-12"> 
					<div className="d-flex categories-main__part mt-5">
						<img src="/images/page2_categories_icon-head.svg" className="categories-main__part__logo" />
				...
				<div className="col-lg-6 col-md-12"> 
					<div className="d-flex categories-main__part mt-5">
						<img src="/images/page2_categories_icon-square.svg" className="categories-main__part__logo" />
						<div style="margin-left: 3%">
			...
			<div className="row d-flex justify-content-between">
				<div className="col-lg-6 col-md-12">
					<div className="d-flex categories-main__part mt-5">
						<img src="/images/page2_categories_icon-medical_bag.svg" className="categories-main__part__logo" />
						<div style="margin-left: 3%">
				...
				<div className="col-lg-6 col-md-12">
					<div className="d-flex categories-main__part mt-5">
						<img src="/images/page2_categories_icon-book.svg" className="categories-main__part__logo" />
						<div style="margin-left: 3%">
