...
const Contact = () => {
    return (
		<div>
			...
			<div className="row mt-5">
				<div className="col-lg-4 cold-sm-12 contact_header__item">
					<div className="d-flex">
						<div>
							<img src="/images/page_6_phone.svg" />
						</div>
				...
				<div className="col-lg-4 cold-sm-12 contact_header__item">
					<div className="d-flex">
						<div>
							<img src="/images/page_6_email.svg" />
						</div>
						<div style={{marginLeft: '20px'}}>
							<div className="mt-3 contact_header__item__title">Telephone</div>
				...
				<div className="col-lg-4 cold-sm-12 contact_header__item">
					<div className="d-flex">
						<div>
							<img src="/images/page_6_location.svg" />
						</div>
						<div style={{marginLeft: '20px'}}>
			...
			<div className="container mt-5 contact_main">
				<div className="row">
					<div className="col-lg-5 col-md-12">
						<img src="/images/page_6_dot.svg" style={{margin: '50% 30%'}} />
					</div>
						...
						<form action="">
							<div className="contact_main__form bg-white">
								...
								<div className="row mx-5">
									<div className="p-0 mt-5 col-lg-6 col-md-12">
								...
								<div className="row mx-5">
									...
									<div className="mb-5 p-0 mt-5 col-lg-6 col-md-12">
								...
								<div className="row mx-5 mt-5">
									...
									<div className="col-lg-6 col-md-12 p-0 mt-3 text-center">
										<button className="text-white text-uppercase">Send</button>
									</div>
								</div>
						</div> !!!
						</form>
