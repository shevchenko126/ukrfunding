...
const WhoWeAre = () => {
	return (
		<div className="mt-5 container who_we_are">
			<div className="row align-items-center">
				<div className="col-lg-8 col-md-12">
					<div className="mt-3 mb-3 d-flex">
						<img src="/images/page2_who_we_are_line.svg" />
						<span className="color1 h4 who_we_are__header">Who We Are</span>
					</div>
					...
					<div className="who_we_are__item">
						<div className="d-flex">
							<div>
								<img src="/images/page2_who_we_are_trust.svg" className="mt-4 who_we_are__item__icon" />
							</div>
				...
				<div className="col-lg-4 col-md-12">
					<img src="/images/page2_who_we_are_panel.svg" />
				</div>        
			</div>
		</div>
	)
