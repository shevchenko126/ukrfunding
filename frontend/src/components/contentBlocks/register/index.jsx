	...
	return (
		<div className="container">
			<form className='register' onSubmit={(event) => {
				...
				<input className="register-input" id="email" name="email" placeholder="Write Your Email" type="email" min="5" max="40" />
				...
				<input className="register-input" id="password" name="password" placeholder="Write New Password" type="password" min="8" max="30" />
				<h5 className="register-text" for="confPassword">Confirm Password</h5>
				<input className="register-input" id="confPassword" name="confPassword" placeholder="Confirm New Password" type="password" min="8" max="30" />
